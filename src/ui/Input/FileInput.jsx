...
const FileInput = forwardRef(function FileInput({ ...props }, ref) {
  ...
  return (
    <div>
      <label className={`block text-sm font-medium leading-5 ${labelStyles}`}>
        {label}
      </label>
      <div className={`mt-2 ${inputContainerStyles}`}>
        <input
          ref={ref}
          type={"file"}
          id={id}
